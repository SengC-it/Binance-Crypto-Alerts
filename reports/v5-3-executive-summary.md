...
## Findings
1. LONG best structural family: TREND_PULLBACK_LONG; nested OOS 41 trades, AvgR -0.2595, PF 0.6501.
2. SHORT best structural family: FAILED_BREAKOUT_SHORT; nested OOS 177 trades, AvgR 0.1454, PF 1.2460.
3. All registered candidates, including zero-trade and failed candidates, are retained in the candidate reports.
4. Entry extension, stop style, delay and cost stress are reported; selected LONG delay AvgR -0.3997, selected SHORT delay AvgR 0.1839.
