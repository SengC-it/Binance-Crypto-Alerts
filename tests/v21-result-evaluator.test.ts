...
describe("V21 frozen result evaluator", () => {
  ...
  it("supports year/symbol slices and positive-gross concentration", () => {
    const outcomes = [
      outcome("BTCUSDT", "2022", 1, 0.1, 1),
      outcome("BTCUSDT", "2023", 2, -0.02, 2),
      outcome("ETHUSDT", "2024", 3, 0.03, 3),
    ];
  ...
  it("keeps all same-cluster trades together and bootstraps exactly 10000 times", () => {
    const outcomes = [
      outcome("BTCUSDT", "2022", 1, 0.01, 100),
      outcome("ETHUSDT", "2022", 1, 0.02, 100),
      outcome("BNBUSDT", "2023", 2, -0.01, 200),
    ];
